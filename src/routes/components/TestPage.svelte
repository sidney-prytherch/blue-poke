...
<style>
	.item-action {
		...
		top: 0;
		z-index: 99;
		background-image: url('$img/action icon.png');
	...
	.metal-bowl {
		...
		height: 100%;
		aspect-ratio: 1;
		background: url('$img/metal bowl.png') no-repeat;
		background-size: 100% auto;
	}
	...
	.plastic-bowl {
		...
		height: 100%;
		aspect-ratio: 1;
		background: url('$img/plastic bowl.png') no-repeat;
		background-size: 100% auto;
		z-index: 4;
	}
	...
	.soy-container {
		...
		z-index: 1;
		aspect-ratio: 1 / 1;
		background: url('$img/soy container.png');
	...
	.small-bag {
		...
		z-index: 1;
		aspect-ratio: 19 / 33;
		background: url('$img/small bag.png');
		background-repeat: no-repeat;
		background-size: 100% 100%;
	}
	...
	.large-bag {
		...
		z-index: 1;
		aspect-ratio: 19 / 33;
		background: url('$img/large bag.png');
		background-repeat: no-repeat;
		background-size: 100% 100%;
	}
	...
	.napkins {
		...
		z-index: 1;
		aspect-ratio: 7 / 4;
		background: url('$img/napkins.png');
		background-repeat: no-repeat;
		background-size: 100% 100%;
	}
	...
	.bagging-table {
		...
		bottom: 0;
		position: absolute;
		background: url('$img/long table up.png');
		background-size: auto 100%;
	...
	.rice-table {
		...
		right: 0;
		top: 30vh;
		background: url('$img/long table left.png') 0 0 repeat;
		width: 15vw;
		height: 45vh;
		align-items: center;
		background-size: 100% auto;
